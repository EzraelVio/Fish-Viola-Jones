...
# for testing only
features = generate_features(400, 700, "Two Horizontal")
print(features[94702])

# testing matrix calculation
# features = (235, 576, 50, 50)
# feature_value = compute_feature_with_matrix(images[0], 0, "Two Horizontal", features[94702])

# testing integral image calculation
b, g, r = combine_integral_grb(images[0])
feature_value = compute_feature_value(b, "Two Horizontal", features[94702])
