...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.6\textwidth]{gambar/training\_flowchart\_riil}
  \caption{Diagram alir untuk algoritma pelatihan klasifikasi objek}
\end{figure}

\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.6\textwidth]{gambar/use\_flochart\_riil}
...
\textit{Dataset} yang akan dipakai diambil dari FishBase (Dapat dilihat di \cite{fishbase}: https://fishbase.mnhn.fr/) yang 
...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.3\textwidth]{gambar/window\_compund}
...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.3\textwidth]{gambar/feature\_data\_2}
...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.6\textwidth]{gambar/features\_image}
...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.3\textwidth]{gambar/decision\_tree\_1}
...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.4\textwidth]{gambar/sliding\_window\_3}
...
\begin{figure}[H]
  \centering{}
	\includegraphics[width=0.4\textwidth]{gambar/hasil\_klasifikasi}
